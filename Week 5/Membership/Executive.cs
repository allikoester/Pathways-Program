namespace Membership
{
    class Executive : Membership, ISpecialOffer
    {
        ...
        public Executive(double cashBackPercent, int memberID, string memberEmail, string membershipType, double annualCost, double amountPurchased)
        ...
        public override void ApplyCashBack(int memberID)
        {
            ...
            {
                CashBack = AmountPurchased * ((CashBackPercent * 1.5) / 100);
            }
            else
            {
        ...
        {
            double SpecialOffer = AnnualCost * 0.5;
            return SpecialOffer;
        }
